...
const CardOption = ({ title, description, image }: CardOptionProps) => {
    return (
        <>
            ...
            <div className="flex w-52 h-full flex-col bg-gray-900 shadow-blue rounded-xl gap-2 transition-all duration-300 hover:scale-150 hover:z-10 cursor-pointer">
